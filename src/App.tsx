  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', background: 'var(--bg-primary)' }}>
      ...
      >
        ...
        {/* Expiry picker — hidden on mobile (shown in sidebar) */}
        <select
          value={expiry}
        ...
        {/* Invite link — hidden on mobile */}
        <span className="desktop-only"><InviteButton roomId={roomId} /></span>

        {/* Room code badge — hidden on mobile */}
        <span className="desktop-only"><RoomBadge roomId={roomId} /></span>
