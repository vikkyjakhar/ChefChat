...
export default defineConfig(({ mode }) => {
  // ui_files/make/deploy-preview passes `--mode development` for cached-preview builds.
...
/** Applies /ui_files/make/site.json to the generated document shell. */
...
/**
 * Serves a blank render-target page at /ui_files/make/kit.html that
...
function figmaMakeKitPlugin(options: { storiesGlob: string | string[] }): Plugin {
  ...
  const ROUTE = '/ui_files/make/kit.html'
